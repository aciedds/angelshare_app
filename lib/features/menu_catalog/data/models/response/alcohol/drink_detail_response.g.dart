...
_$DrinkDetailResponseImpl _$$DrinkDetailResponseImplFromJson(
  Map<String, dynamic> json,
) => _$DrinkDetailResponseImpl(
  drinks: (json['drinks'] as List<dynamic>)
      .map((e) => DrinkDetailResponseItem.fromJson(e as Map<String, dynamic>))
      .toList(),
);

Map<String, dynamic> _$$DrinkDetailResponseImplToJson(
  _$DrinkDetailResponseImpl instance,
) => <String, dynamic>{'drinks': instance.drinks};

_$DrinkDetailResponseItemImpl _$$DrinkDetailResponseItemImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$DrinkDetailResponseItemImplToJson(
  _$DrinkDetailResponseItemImpl instance,
) => <String, dynamic>{
